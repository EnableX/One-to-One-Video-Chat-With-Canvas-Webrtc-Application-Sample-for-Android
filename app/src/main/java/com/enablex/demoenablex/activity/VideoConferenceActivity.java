...
public class VideoConferenceActivity extends AppCompatActivity
    ...
    public void onRoomConnected(EnxRoom enxRoom, JSONObject jsonObject) {
        ...
        enxRooms = enxRoom;
        if (enxRooms != null) {enxPlayerView = new EnxPlayerView(this, EnxPlayerView.ScalingType.SCALE_ASPECT_BALANCED, true);
            ...
            if(id== R.id.disconnect) {
                ...
                if (enxRooms != null) {
                    if (canvas.getText().toString().equalsIgnoreCase("Start Canvas")) {
                        ...
                        enxRooms.startCanvas(canvas_view);
                    } else {
                        enxRooms.stopCanvas();
                    }
...
//            super.onBackPressed();
    ...
    private void setUI() {
        ...
        canvas_view = (RelativeLayout) findViewById(R.id.canvas_view);
        canvas = (TextView) findViewById(R.id.canvas);
        change_color = (TextView) findViewById(R.id.change_color);
